...
public class LoginPets extends Application {
...
// Calcular el ancho máximo para los campos de texto
        ...
        usernameLabel.setStyle("-fx-font-size: 13px;-fx-text-fill: #000000;-fx-font-weignt: bold");
        usernameField.setMaxWidth(maxWidth);

        Label passwordLabel = new Label("Contraseña:");
        passwordLabel.setStyle("-fx-font-size: 13px;-fx-text-fill: #000000;-fx-font-weignt: bold");
        ...
        Image bannerImage = new Image("PETS_PROJECT/banner.png");
        ...
        titleLabel.setStyle("-fx-font-size: 18px; -fx-font-weight: bold;-fx-text-fill: #000000"); // Estilos para el título
        ...
        formLayout.setStyle("-fx-background-color: #49bee1f8; -fx-background-radius: 10; -fx-padding: 20; -fx-spacing: 10;");
...
// Establecer el tamaño de la escena
    ...
    private void openEmployeeManager() {
        primaryStage.close();
        TablaBaseDatos tablaBaseDatos_1 = new TablaBaseDatos();
        tablaBaseDatos_1.start(new Stage());
    }
    ...
    private void showChangePasswordDialog() {
        ...
        changePasswordStage.getIcons().add(icon);
